...
- [x] Upgrade to Premium button in settings → Stripe Checkout + Customer Portal ✅
- [x] Premium tier gating: TOTP, vault health, file attachments, custom fields, tags, export ✅
- [x] Billing page with monthly/annual toggle ($4/mo monthly, $3/mo annual) ✅
